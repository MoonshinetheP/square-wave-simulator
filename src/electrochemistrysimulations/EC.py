...
if __name__ == '__main__':
    ...
    instance = EC(input = shape, E0 = 0.25, k0 = 0.1, a = 0.5, k1 = 0.001, cR = 0.005, cO = 0.000, cY = 0, DR = 5E-6, DO = 5E-6, DY = 5E-6, r = 0.15, expansion = 1.05, Nernstian = False, BV = True, MH = False)
    
    filepath = cwd + '/data/' + 'EC 0.001' + '.txt'
