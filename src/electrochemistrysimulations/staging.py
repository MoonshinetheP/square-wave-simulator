...
if __name__ == '__main__':
    ...
    shape = wf.CV(Eini = 0.0, Eupp = 0.5, Elow = 0.0, dE = 0.001, sr = 0.1, ns = 1)
    instance = EC(input = shape, E0 = 0.25, k0 = 0.001, a = 0.5, k1 = 1, cR = 0.000005, cO = 0.000000, cY = 0.000000, DR = 5E-6, DO = 5E-6, DY = 5E-6, r = 0.1, expansion = 1.05, Nernstian = False, BV = True, MH = False)
