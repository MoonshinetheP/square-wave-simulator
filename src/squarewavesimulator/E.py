...
if __name__ == '__main__':
    ...
    instance = E(input = shape, E0 = 0.25, k0 = 0.1, a = 0.5, cR = 0.005, cO = 0.000, DR = 7.5E-6, DO = 5E-6, r = 0.15, expansion = 1.05, Nernstian = False, BV = True, MH = False)
    
    filepath = cwd + '/data/' + 'DR 7.5E-6' + '.txt'
